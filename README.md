...
```
Azad, K. and Holt, D. Benchmarking Multi-Modal Fusion Strategies for Relapse
Prediction in Bipolar Disorder using Wearable Data. Machine Learning for
Healthcare (MLHC), 2026.
```
